...
namespace RentalKendaran.Controllers
{
    public class JaminansController : Controller
    {
        ...
        {
            var rentKendaraanContext = _context.Jaminans.Include(j => j.IdJaminanNavigation);
        ...
        {
            ViewData["IdJaminan"] = new SelectList(_context.Pengembalians, "IdPeminjaman", "IdPeminjaman");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdJaminan,NamaJaminan")] Jaminan jaminan)
        {
            ...
            ViewData["IdJaminan"] = new SelectList(_context.Pengembalians, "IdPeminjaman", "IdPeminjaman", jaminan.IdJaminan);
            return View(jaminan);
        }
