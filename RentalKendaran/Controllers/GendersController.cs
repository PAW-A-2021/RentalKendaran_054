...
namespace RentalKendaran.Controllers
{
    public class GendersController : Controller
    {
        ...
        {
            var rentKendaraanContext = _context.Genders.Include(g => g.IdGenderNavigation);
        ...
        {
            ViewData["IdGender"] = new SelectList(_context.Customers, "IdCustomer", "IdCustomer");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdGender,NamaGender")] Gender gender)
        {
            ...
            ViewData["IdGender"] = new SelectList(_context.Customers, "IdCustomer", "IdCustomer", gender.IdGender);
            return View(gender);
        }
